...
Route::get('/admin/pesan', [AdminController::class, 'messages'])->name('admin.pesan');
...
Route::prefix('admin')->middleware(['auth', 'admin'])->group(function () {
    ...
    Route::delete('/bookings/{id}', [AdminController::class, 'deleteBooking'])->name('admin.bookings.destroy');
    Route::delete('/admin/users/{id}', [AdminController::class, 'deleteUser'])->name('admin.users.destroy');
    Route::delete('/admin/pesan/{id}', [AdminController::class, 'deleteMessage'])->name('admin.pesan.destroy');
    ...
    // API real-time fetch gallery
    Route::get('/api/gallery', [AdminGalleryController::class, 'apiIndex'])->name('admin.gallery.api');

    // Rute Profile
    Route::get('/profile', [TentangController::class, 'edit'])->name('admin.profile');
    Route::post('/profile/update', [TentangController::class, 'update'])->name('admin.profile.update');

    // Rute Kamar Status
    Route::get('/kamarstatus', [KamarStatusController::class, 'index'])->name('admin.kamarstatus');
    Route::post('/kamarstatus/{nama_kamar}', [KamarStatusController::class, 'update'])->name('admin.kamarstatus.update');
});
