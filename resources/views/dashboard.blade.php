...
<head>
    ...
    <title>Dashboard - Jaya Kost</title>
...
<div class="flex h-screen overflow-hidden">
    ...
    <main class="flex-1 p-4 md:p-8 overflow-y-auto bg-gradient-to-tr from-gray-950 via-gray-900 to-gray-800 w-full pt-16 md:pt-8">
        <div class="mb-4 md:mb-6">
            <h2 class="text-2xl md:text-3xl font-bold text-cyan-400 drop-shadow-md">⚡ Dashboard</h2>
        </div>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            ...
            <a href="{{ route('admin.users') }}"
                ...
                <h3 class="text-base md:text-lg font-semibold text-cyan-300">Users</h3>
