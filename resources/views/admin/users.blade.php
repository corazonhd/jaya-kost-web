...
<div class="flex h-screen overflow-hidden">
    ...
    <main class="flex-1 p-4 md:p-8 overflow-y-auto bg-gradient-to-tr from-gray-950 via-gray-900 to-gray-800 w-full md:ml-64 pt-16 md:pt-8">
        <div class="mb-6">
            <h2 class="text-2xl md:text-3xl font-bold text-cyan-400 drop-shadow-md">👥 Users</h2>
            <p class="text-gray-400">Daftar semua user yang terdaftar di sistem</p>
        </div>
